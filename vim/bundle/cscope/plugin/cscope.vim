...
if has("cscope")
    " comment this if you want to use CTRL-t to jump back
...
"---------------------------------------------------------
map <leader>cs :call CscopeFind('n', 's', expand('<cword>'))<CR>
map <leader>cg :call CscopeFind('n', 'g', expand('<cword>'))<CR>
map <leader>cd :call CscopeFind('n', 'd', expand('<cword>'))<CR>
map <leader>cc :call CscopeFind('n', 'c', expand('<cword>'))<CR>
map <leader>ct :call CscopeFind('n', 't', expand('<cword>'))<CR>
map <leader>ce :call CscopeFind('n', 'e', expand('<cword>'))<CR>
map <leader>cf :call CscopeFind('n', 'f', expand('<cword>'))<CR>
map <leader>ci :call CscopeFind('n', 'i', expand('<cword>'))<CR>

"                 Split Buffer Horizontally:
"---------------------------------------------------------
map <leader>scs :call CscopeFind('s', 's', expand('<cword>'))<CR>
map <leader>scg :call CscopeFind('s', 'g', expand('<cword>'))<CR>
map <leader>scd :call CscopeFind('s', 'd', expand('<cword>'))<CR>
map <leader>scc :call CscopeFind('s', 'c', expand('<cword>'))<CR>
map <leader>sct :call CscopeFind('s', 't', expand('<cword>'))<CR>
map <leader>sce :call CscopeFind('s', 'e', expand('<cword>'))<CR>
map <leader>scf :call CscopeFind('s', 'f', expand('<cword>'))<CR>
map <leader>sci :call CscopeFind('s', 'i', expand('<cword>'))<CR>

"                 Split Bucfer Vertically:
"---------------------------------------------------------
map <leader>vcs :call CscopeFind('v', 's', expand('<cword>'))<CR>
map <leader>vcg :call CscopeFind('v', 'g', expand('<cword>'))<CR>
map <leader>vcd :call CscopeFind('v', 'd', expand('<cword>'))<CR>
map <leader>vcc :call CscopeFind('v', 'c', expand('<cword>'))<CR>
map <leader>vct :call CscopeFind('v', 't', expand('<cword>'))<CR>
map <leader>vce :call CscopeFind('v', 'e', expand('<cword>'))<CR>
map <leader>vcf :call CscopeFind('v', 'f', expand('<cword>'))<CR>
map <leader>vci :call CscopeFind('v', 'i', expand('<cword>'))<CR>

"-----------------------------------------------------------
map <leader>l :call ToggleLocationList()<CR>

function! CscopeFind(window, action, word)
  ...
  if r
    try
      ...
      "lw "open the quickfix windows, now I comment it.
    catch
