...
function! SingleCompile#templates#markdown#Initialize()
    call SingleCompile#SetCompilerTemplate('mkd', 'pandoc',
                \ 'General markup converter', 'pandoc',
                \ '-o $(FILE_TITLE)$.html',
                \ SingleCompile#GetDefaultOpenCommand() .
                \ ' "$(FILE_TITLE)$.html"')
    call SingleCompile#SetPriority('mkd', 'pandoc', 50)

    call SingleCompile#SetCompilerTemplate('mkd', 'rdiscount',
